import "./return_page.scss";
import DataTable from "react-data-table-component";
import { useState, useEffect } from "react";
import { CustomStyle } from "../../js/service_return_table";
...
const ReturnPage = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      await fetch("https://library2.herokuapp.com/book_return_sessions", {
        method: "GET",
      })
        .then((res) => res.json())
        .then((usersData) =>
